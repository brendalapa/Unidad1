...
function mostrarResultado(){
    ...
    div.innerHTML = "<h3 class='resultado-titulo'>Resultados</h3>"
    ...
    div.innerHTML += `<p class = "resultado-obtenido">Has obtenido ${puntaje} puntos, lo cual significa que tu estilo de vida es ${estilovida}.</p>`
}
...
document.getElementById("op1").addEventListener("click", function(){actualizarPuntaje(1)});
document.getElementById("op2").addEventListener("click", function(){actualizarPuntaje(2)});
document.getElementById("op3").addEventListener("click", function(){actualizarPuntaje(3)});
document.getElementById("op4").addEventListener("click", function(){actualizarPuntaje(4)});
document.getElementById("op5").addEventListener("click", function(){actualizarPuntaje(5)});
